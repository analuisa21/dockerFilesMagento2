...
RUN pecl install xdebug-2.4.1 && docker-php-ext-enable xdebug \
    ...
    && echo "xdebug.remote_host=192.168.1.58" >> /usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini \
